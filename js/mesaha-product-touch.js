...
(function(){
  ...
  function persist(settings){try{if(typeof window.saveSettings==='function')window.saveSettings();else if(typeof window.__flushSettings==='function')Promise.resolve(window.__flushSettings('product-select')).catch(function(){})}catch(e){}}
