/* module: mesaha-drive-bridge.js */
/* Mesaha İO V5.73 — Drive yedek silme aktif ve güvenli köprü */
(function(){
  'use strict';
...
(function(){
  'use strict';
  if(window.MESAHA_SUITE_MODE){
    var suiteCloudStub={version:'suite-v28',suiteManaged:true,backup:async function(){throw new Error('Yedekler Orman İO üzerinden yönetilir')},list:async function(){return[]},openCloudRestore:function(){location.href='../'},restore:async function(){return false},deleteBackup:async function(){return false}};
