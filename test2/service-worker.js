...
const CACHE_NAME = (self.MESAHA_VERSION && self.MESAHA_VERSION.cacheName) || 'mesaha-app-v187-final-fixes';
const CORE_ASSETS = [
  './',
  './index.html',
  './admin.html',
  ...
  './css/mesaha-v187-final-fixes.css?v=187',
  './js/version.js?v=187',
  ...
  './js/mesaha-v187-final-fixes.js?v=187'
];
