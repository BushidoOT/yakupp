...
const SHELL_ASSETS = [
  ...
  './js/version.js?v=444', './js/mesaha-early-optimizer.js?v=444', './js/mesaha-utils.js?v=444', './js/mesaha-data-guard.js?v=444',
  './js/mesaha-stability-core.js?v=444', './js/mesaha-supabase-config.js?v=444', './js/mesaha-firebase.js?v=444', './js/mesaha-offline-core.js?v=444',
  './js/mesaha-render-storage.js?v=444', './js/mesaha-sound.js?v=444'
];
const STATIC_ASSETS = [
  './assets/icon-192.png', './assets/icon-512.png', './assets/mesaha_logo.png', './assets/hero_forest_cover.png?v=444',
  './assets/mesaha_onay.wav?v=444', './assets/mesaha_uyari.wav?v=444'
];
