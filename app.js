(function () {
  ...
  const CURRENT_SUITE_LABEL = clean(window.MESAHA_VERSION?.visibleVersion || "Mesaha Suite V18");
  ...
  async function applySuiteUpdate() {
    ...
    try {
      ...
      if (!reg && "serviceWorker" in navigator) reg = await navigator.serviceWorker.register("./service-worker.js?v=18", { scope: "./", updateViaCache: "none" });
      if (reg) {
  ...
  async function createTerminalCodeSuite() {
    ...
    try {
      const out = await supabaseRpc("mesaha_create_terminal_code_v557", {
        p_label: "terminal",
        p_app_version: "Mesaha Suite V18",
      });
  ...
  async function divisionYieldStats(bolme) {
    ...
    if (navigator.onLine !== false) {
      try {
        const api = window.MesahaSuiteSyncV18 || window.MesahaSuiteSyncV17 || window.MesahaSuiteSyncV14 || window.MesahaSuiteSyncV13 || window.MesahaSuiteSyncV12 || window.MesahaSuiteSyncV11 || window.MesahaSuiteSyncV10;
  ...
  async function prepareOffline() {
    ...
    try {
      ...
      const reg = await navigator.serviceWorker.register("./service-worker.js?v=18", { scope: "./", updateViaCache: "none" });
  ...
  function handleAction(target, ev) {
    ...
    if (tool === "sync" || tool === "server") {
      if (window.MesahaSuiteSyncV18 || window.MesahaSuiteSyncV17 || window.MesahaSuiteSyncV14 || window.MesahaSuiteSyncV13 || window.MesahaSuiteSyncV12 || window.MesahaSuiteSyncV11 || window.MesahaSuiteSyncV10 || window.MesahaSuiteSyncV9 || window.MesahaSuiteSyncV8)
        (window.MesahaSuiteSyncV18 || window.MesahaSuiteSyncV17 || window.MesahaSuiteSyncV14 || window.MesahaSuiteSyncV13 || window.MesahaSuiteSyncV12 || window.MesahaSuiteSyncV11 || window.MesahaSuiteSyncV10 || window.MesahaSuiteSyncV9 || window.MesahaSuiteSyncV8).syncAll({ source: tool })
