/* Mesaha İO V5.54 — giriş teşhis/log tutucu.
   Amaç: Google/Supabase giriş akışındaki gerçek kırılma noktasını güvenli şekilde kaydetmek. */
(function(){
  'use strict';
  if(window.MesahaLoginLog&&window.MesahaLoginLog.version==='v554')return;
  var VERSION='v554', KEY='mesaha_login_debug_v554', QKEY='mesaha_login_debug_queue_v554', SID_KEY='mesaha_login_debug_session_v554';
