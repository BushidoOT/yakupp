/* Mesaha İO V5.72 — Google OAuth + terminal kod eşleştirme + panel üstü modal ve misafir terminal modu.
...
(function(){
  ...
  async function claimTerminalCode(codeArg){
    ...
    try{
      var out=await anonRpc('mesaha_claim_terminal_code_v557',{p_code:code,p_device_info:deviceInfo(),p_app_version:(window.MESAHA_VERSION||{}).visibleVersion||'V5.72'});
