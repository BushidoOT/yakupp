/* Mesaha İO V5.55 — giriş teşhis/log tutucu.
   Amaç: Google/Supabase giriş akışındaki gerçek kırılma noktasını güvenli şekilde kaydetmek. */
(function(){
  'use strict';
  if(window.MesahaLoginLog&&window.MesahaLoginLog.version==='v555')return;
  var VERSION='v555', KEY='mesaha_login_debug_v555', QKEY='mesaha_login_debug_queue_v555', SID_KEY='mesaha_login_debug_session_v555';
