importScripts('./js/version.js?v=201');
const CACHE_NAME = (self.MESAHA_VERSION && self.MESAHA_VERSION.cacheName) || 'mesaha-app-v201-hide-nav-fast-entry';
const CORE_ASSETS = [
  './',
  './index.html',
  './admin.html',
  ...
  './css/style.css?v=201',
  './css/dark.css?v=201',
  './css/ios-entry.css?v=201',
  './css/entry-mode.css?v=201',
  './js/version.js?v=201',
  './js/admin-access.js?v=201',
  './js/startup-offline.js?v=201',
  './js/core.js?v=201',
  './js/admin-cloud.js?v=201',
  './js/tree-entry.js?v=201',
  './js/ui-mobile.js?v=201',
  './js/records-filters.js?v=201',
  './js/backup-storage.js?v=201',
  './js/keyboard-filters.js?v=201',
  './js/cutters.js?v=201',
  './js/filters-stability.js?v=201',
  './js/stability-base.js?v=201',
  './js/control-test.js?v=201',
  './js/stability-admin.js?v=201',
  './js/offline-admin.js?v=201',
  './js/app-stability.js?v=201',
  './js/auto-update.js?v=201',
  './js/ios-entry.js?v=201',
  './js/entry-mode.js?v=201'
];
