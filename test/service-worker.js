importScripts('./js/version.js?v=193');
const CACHE_NAME = (self.MESAHA_VERSION && self.MESAHA_VERSION.cacheName) || 'mesaha-app-v193-temiz-paket';
const CORE_ASSETS = [
  './',
  './index.html',
  './admin.html',
  ...
  './css/style.css?v=193',
  './css/dark.css?v=193',
  './css/ios-entry.css?v=193',
  './css/entry-mode.css?v=193',
  './js/version.js?v=193',
  './js/admin-access.js?v=193',
  './js/startup-offline.js?v=193',
  './js/core.js?v=193',
  './js/admin-cloud.js?v=193',
  './js/tree-entry.js?v=193',
  './js/ui-mobile.js?v=193',
  './js/records-filters.js?v=193',
  './js/backup-storage.js?v=193',
  './js/keyboard-filters.js?v=193',
  './js/cutters.js?v=193',
  './js/filters-stability.js?v=193',
  './js/stability-base.js?v=193',
  './js/control-test.js?v=193',
  './js/stability-admin.js?v=193',
  './js/offline-admin.js?v=193',
  './js/app-stability.js?v=193',
  './js/auto-update.js?v=193',
  './js/ios-entry.js?v=193',
  './js/entry-mode.js?v=193'
];
