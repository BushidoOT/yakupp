...
const VERSION = window.MESAHA_VERSION || {shortVersion:'v3.16', version:'v316-user-admin-panel-fix'};
const PRODUCTS = [
...
function backupJson(){ const data={version:'v3.16-extras', exportedAt:new Date().toISOString(), records:state.records, settings:state.settings}; downloadText(JSON.stringify(data,null,2), `mesaha_yedek_${formatDateFile()}.json`, 'application/json'); toast('Yedek indirildi.'); }
