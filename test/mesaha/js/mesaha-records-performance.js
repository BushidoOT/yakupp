(function(){
  ...
  function info(){var s=state(), r=s&&Array.isArray(s.records)?s.records:[]; return {records:r.length, pageSize:20, recordsViewActive:!!((document.getElementById('recordsView')&&document.getElementById('recordsView').classList.contains('active'))||(document.getElementById('beyanView')&&document.getElementById('beyanView').classList.contains('active')))};}
