...
(function(){
  ...
  if(window.MESAHA_SUITE_MODE){
    var suiteCloudStub={version:'suite-v9',suiteManaged:true,backup:async function(){throw new Error('Yedekler Mesaha Suite üzerinden yönetilir')},list:async function(){return[]},openCloudRestore:function(){location.href='../'},restore:async function(){return false},deleteBackup:async function(){return false}};
